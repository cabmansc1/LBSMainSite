<?php
// directory-test.php - TEST COPY of directory page for iterating on improvements
...
// Canonical points to the REAL directory page (not this test page)
...
<head>
    ...
    <title>[TEST] <?= htmlspecialchars($pageTitle) ?> - <?= SITE_NAME ?></title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* TEST BANNER */
        .test-banner { background: #fbbf24; color: #92400e; text-align: center; padding: 10px; font-weight: 700; font-size: 0.9rem; }
        ...
        /* ===== Featured Section ===== */
        .featured-section { max-width: 1200px; margin: 0 auto; padding: 30px 20px 0; }
        ...
        .tag-pill {
            ...
            white-space: nowrap; border: 1px solid #bae6fd;
        }
        ...
        .business-card.is-featured { border: 2px solid #f59e0b; background: #fffbeb; }
...
<body>
    ...
    <!-- TEST BANNER -->
    <div class="test-banner">TEST PAGE - This is a working copy of the directory page. Changes here won't affect the live site.</div>
